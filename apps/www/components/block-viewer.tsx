...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/registry/simplifying-ai/ui/collapsible"
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from "@/registry/simplifying-ai/ui/resizable"
...
import {
  ...
  SidebarMenuSub,
  SidebarProvider,
} from "@/registry/simplifying-ai/ui/sidebar"
import { Tabs, TabsList, TabsTrigger } from "@/registry/simplifying-ai/ui/tabs"
import {
  ToggleGroup,
  ToggleGroupItem,
} from "@/registry/simplifying-ai/ui/toggle-group"
    ...
    <div className="hidden w-full items-center gap-2 pl-2 md:pr-6 lg:flex">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <Button
          ...
          onClick={() => {
            copyToClipboard(
              `npx shadcn@latest add "https://ui.simplifyingai.com/r/${item.name}.json"`
            )
          }}
        >
