...
description: Troubleshooting Simplifying AI UI components.
---
...
## I ran the CLI but nothing was added to my project
...
- You're using the correct CLI command:
...
Ensure your app is using the same data-theme system that shadcn/ui expects. The default implementation toggles a data-theme attribute on the `<html>` element. Make sure your tailwind.config.js is using class or data- selectors accordingly.
...
If all else fails, feel free to open an issue on [GitHub](https://github.com/simplifyingai/ui.simplifyingai.com/issues).
