...
<ComponentPreview
  ...
  description="An icicle chart displaying hierarchical data as nested rectangles with labels."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/icicle-chart.json
```
...
<ComponentSource
  name="icicle-chart"
  title="components/ui/charts/icicle-chart.tsx"
/>
