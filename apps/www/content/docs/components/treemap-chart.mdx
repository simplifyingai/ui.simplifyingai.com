...
<ComponentPreview name="treemap-chart-demo" description="A treemap chart displaying hierarchical data as nested rectangles" />
...
<ComponentSource name="treemap-chart" title="components/ui/charts/treemap-chart.tsx" />
