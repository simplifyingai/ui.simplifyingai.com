...
<ComponentPreview
  ...
  description="Slope charts connect data points with lines to emphasize change over time."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/slope-chart.json
```
...
<ComponentSource
  name="slope-chart"
  title="components/ui/charts/slope-chart.tsx"
/>
