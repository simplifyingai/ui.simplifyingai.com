...
<ComponentPreview
  ...
  description="A contour chart showing filled regions and iso-lines connecting points of equal value."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/contour-chart.json
```
...
<ComponentSource
  name="contour-chart"
  title="components/ui/charts/contour-chart.tsx"
/>
