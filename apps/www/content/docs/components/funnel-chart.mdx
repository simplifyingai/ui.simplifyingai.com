...
<ComponentPreview
  ...
  description="A multi-series funnel chart displaying flowing streams through different stages with value pills and stage markers."
/>
...
<ComponentSource
  name="funnel-chart"
  title="components/ui/charts/funnel-chart.tsx"
/>
