...
<ComponentPreview
  ...
  description="Rose chart for visualizing cyclic and directional data"
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/polar-chart.json
```
...
<ComponentSource
  name="polar-chart"
  title="components/ui/charts/polar-chart.tsx"
/>
