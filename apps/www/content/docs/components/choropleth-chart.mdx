...
<ComponentPreview
  ...
  description="A world map with color-coded regions based on data values, supporting multiple projections and custom maps."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/choropleth-chart.json
```
...
<ComponentSource
  ...
  title="components/ui/charts/choropleth-chart.tsx"
/>
