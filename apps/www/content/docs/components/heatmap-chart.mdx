...
<ComponentPreview name="heatmap-chart-demo" description="A matrix heatmap displaying data intensity with color gradients across rows and columns." />
...
<ComponentSource name="heatmap-chart" title="components/ui/charts/heatmap-chart.tsx" />
