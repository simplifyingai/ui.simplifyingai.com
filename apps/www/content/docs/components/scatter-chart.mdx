...
<ComponentPreview name="scatter-chart-demo" description="Scatter charts display the relationship between two numerical variables with support for multiple data series, various point symbols, and trend lines." />
...
<ComponentSource name="scatter-chart" title="components/ui/charts/scatter-chart.tsx" />
