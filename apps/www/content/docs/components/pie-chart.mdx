...
<ComponentPreview name="pie-chart-demo" description="Circular chart showing proportional data distribution" />
...
<ComponentSource name="pie-chart" title="components/ui/charts/pie-chart.tsx" />
