...
<ComponentPreview name="sankey-chart-demo" description="Flow diagrams displaying relationships between nodes with link widths proportional to flow values, built with D3-Sankey." />
...
<ComponentSource name="sankey-chart" title="components/ui/charts/sankey-chart.tsx" />
