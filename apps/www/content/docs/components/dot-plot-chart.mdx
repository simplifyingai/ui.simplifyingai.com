...
<ComponentPreview
  ...
  description="A stacked dot plot showing the frequency distribution of values."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/dot-plot-chart.json
```
...
<ComponentSource
  name="dot-plot-chart"
  title="components/ui/charts/dot-plot-chart.tsx"
/>
