...
<ComponentPreview
  ...
  description="A sunburst chart displaying hierarchical data as concentric rings"
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/sunburst-chart.json
```
...
<ComponentSource
  name="sunburst-chart"
  title="components/ui/charts/sunburst-chart.tsx"
/>
