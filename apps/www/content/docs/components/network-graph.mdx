...
<ComponentPreview name="network-graph-demo" description="Force-directed graph showing relationships between nodes" />
...
<ComponentSource name="network-graph" title="components/ui/charts/network-graph.tsx" />
