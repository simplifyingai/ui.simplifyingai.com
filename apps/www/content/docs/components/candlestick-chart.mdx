...
<ComponentPreview
  ...
  description="A financial candlestick chart for visualizing OHLC price data with bullish and bearish indicators."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/candlestick-chart.json
```
...
<ComponentSource
  ...
  title="components/ui/charts/candlestick-chart.tsx"
/>
