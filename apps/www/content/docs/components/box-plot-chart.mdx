...
<ComponentPreview name="box-plot-chart-demo" description="A box and whisker plot for visualizing statistical distributions with quartiles and outliers." />
...
<ComponentSource name="box-plot-chart" title="components/ui/charts/box-plot-chart.tsx" />
