...
<ComponentPreview
  ...
  description="A box and whisker plot for visualizing statistical distributions with quartiles and outliers."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/box-plot-chart.json
```
...
<ComponentSource
  name="box-plot-chart"
  title="components/ui/charts/box-plot-chart.tsx"
/>
