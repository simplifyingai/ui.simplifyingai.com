...
<ComponentPreview name="waterfall-chart-demo" description="A waterfall chart showing the cumulative effect of sequential positive and negative values" />
...
<ComponentSource name="waterfall-chart" title="components/ui/charts/waterfall-chart.tsx" />
