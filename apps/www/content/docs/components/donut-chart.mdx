...
<ComponentPreview
  ...
  description="An interactive ring chart with proportional segments and smooth animations."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/donut-chart.json
```
...
<ComponentSource
  name="donut-chart"
  title="components/ui/charts/donut-chart.tsx"
/>
