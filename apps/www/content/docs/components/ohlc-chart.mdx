...
<ComponentPreview
  ...
  description="Open-High-Low-Close chart displaying financial data"
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/ohlc-chart.json
```
...
<ComponentSource
  name="ohlc-chart"
  title="components/ui/charts/ohlc-chart.tsx"
/>
