...
<ComponentPreview
  ...
  description="A tree diagram showing hierarchical relationships and clustering."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/dendrogram.json
```
...
<ComponentSource
  name="dendrogram"
  title="components/ui/charts/dendrogram.tsx"
/>
