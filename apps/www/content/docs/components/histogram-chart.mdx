...
<ComponentPreview name="histogram-chart-demo" description="A histogram chart displaying data distribution across bins with customizable bar styling." />
...
<ComponentSource name="histogram-chart" title="components/ui/charts/histogram-chart.tsx" />
