...
<ComponentPreview
  ...
  description="A 2D density plot showing point distribution using kernel density estimation."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/density-chart.json
```
...
<ComponentSource
  name="density-chart"
  title="components/ui/charts/density-chart.tsx"
/>
