...
<ComponentPreview name="radar-chart-demo" description="A radar chart displaying multivariate data on axes starting from the same point with support for multiple series comparison." />
...
<ComponentSource name="radar-chart" title="components/ui/charts/radar-chart.tsx" />
