...
<ComponentPreview
  ...
  description="A compact performance indicator showing actual values against targets and qualitative ranges."
/>
...
```bash
npx shadcn@latest add https://ui.simplifyingai.com/r/bullet-chart.json
```
...
<ComponentSource
  name="bullet-chart"
  title="components/ui/charts/bullet-chart.tsx"
/>
